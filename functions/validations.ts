 ...
 */
export function isIn(value: any, tests: any[]): boolean {
 ...
 * @param tests An array of values to test
 */
export function propertyIsEqual(
 ...
 * @param secondArray
 */
export function hasCommonElement(
  firstArray: any[],
  secondArray: any[]
): boolean {
  return firstArray.some((item: any) => secondArray.includes(item));
}
